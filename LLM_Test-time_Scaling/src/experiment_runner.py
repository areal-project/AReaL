...
class ExperimentRunner:
    ...
    def _create_evaluator(self) -> Optional[Evaluator]:
        ...
        elif evaluator_type == "imobench_boxed":
            return BoxedIMOBenchEvaluator()
    ...
    def _create_pipeline(self) -> ScalingPipeline:
        ...
        return ScalingPipeline(
            ...
            task_domain=task_domain,
            direct_prompt_template_name=self.config.llm.direct_prompt_template,
        )
    ...
    async def run_benchmark(self, benchmark_name: str) -> ExperimentResult:
        ...
        benchmark_file = getattr(self.config.evaluation, 'benchmark_file', None)
        if splits:
