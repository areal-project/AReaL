...
from .partitioned_rope import PartitionedRotaryEmbedding
from .chunked_rope import ChunkedRotaryEmbedding, compute_chunked_positions
...
def get_rope(
    ...
    if dual_chunk_attention_config is not None:
        ...
        elif scaling_type == "partitioned":
            period = rope_parameters.get("period", 512)
            rotary_emb = PartitionedRotaryEmbedding(
                head_size,
                rotary_dim,
                max_position,
                base,
        ...
        elif scaling_type == "chunked":
            rotary_emb = ChunkedRotaryEmbedding(
                head_size,
                rotary_dim,
                max_position,
                base,
                is_neox_style,
                dtype,
                chunk_partition_ratio=rope_parameters.get(
