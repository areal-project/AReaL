...
LOGFILE=${PROJECT_DIR}/logs/llb_os_memrl_haiku_resume_${HOST_SHORT}_${TS}.log
mkdir -p ${PROJECT_DIR}/logs
exec > >(tee -a $LOGFILE) 2>&1

echo "=========================================="
echo "RESUME LLB OS MemRL (claude-haiku-4-5) from ckpt"
...
export MEMRL_RUN_ID=20260711-022606
