#!/bin/bash
#SBATCH --job-name=yl-bcb-ds-tuned-region
...
#SBATCH --mem=200G
#SBATCH --gres=gpu:5
#SBATCH --exclude=slurmd-24,slurmd-14
#SBATCH --output=logs/bcb_ds_tuned_region_%j.log
#SBATCH --error=logs/bcb_ds_tuned_region_%j.log
...
echo ''
echo '=========================================='
echo '[REGION+TUNED] Starting BCB Region Memory Transfer with tuned parameters'
echo 'Config: tau=0.30, proceduralization, query, sim_norm=0.31/0.10'
echo '=========================================='
