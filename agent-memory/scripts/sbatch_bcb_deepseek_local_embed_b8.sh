...
#SBATCH --output=logs/bcb_ds_local_embed_b8_%j.log
#SBATCH --error=logs/bcb_ds_local_embed_b8_%j.log
...
echo "=========================================="
echo "BCB DeepSeek-R1-32B + Qwen3-Embedding-8B (batch_size=8)"
...
# --- Run MemRL experiment (batch_size=8) ---
echo ''
echo '=========================================='
echo '[MEMRL] Starting BCB MemRL with local embedding (batch_size=8, 10 epochs)'
echo '=========================================='
