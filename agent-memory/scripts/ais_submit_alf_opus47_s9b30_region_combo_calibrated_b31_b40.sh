...
# --- 作业信息 ---
export WORKER_NUM=0
export JOB_NAME="yl-alf-opus47-region-combo-cal-b31b40-$(date +%m%d-%H%M)"
...
# --- 启动命令 ---
export JOB_COMMAND="bash /storage/openpsi/users/yl/agent-memory/MemRL/scripts/ais_run_alf_opus47_s9b30_region_combo_calibrated_b31_b40.sh"
