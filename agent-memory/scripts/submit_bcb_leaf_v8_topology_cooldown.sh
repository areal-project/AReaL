#!/bin/bash
# Leaf-v8 topology schedule: retain raw direct outcomes before the first Region cluster, then
...
export JOB_NAME="yl-bcb-leafv8-cooldown1-$STAMP"
export BCB_CONFIG=configs/rl_bcb_config.deepseek_v3_local_region.yaml
export BCB_EPOCHS=10
export BCB_OUTPUT_DIR=/storage/openpsi/experiments/checkpoints/admin/yl-mem-region/bigcodebench/deepseek_v3_local_region_fs_leaf_v8_cooldown1
...
LOG_BASE="$MEMRL/logs/aistudio_bcb_leafv8_cooldown1_$STAMP"
