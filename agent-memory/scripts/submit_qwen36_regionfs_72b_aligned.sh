#!/bin/bash
# Submit Qwen3.6 Region+FS run aligned to 72B topology-stability Cell A.
set -euo pipefail
...
export WORKER_NUM="0"
export JOB_TAG="qwen36-regionfs-72b-aligned"
export JOB_NAME="yl-alf-qwen36-regionfs-72b-aligned-${TS}"
export KM_IMAGE="acr-sh-ant-registry-vpc.cn-shanghai.cr.aliyuncs.com/gpu/areal-runtime:dev-vllm-20260429"
export JOB_COMMAND="bash /storage/openpsi/users/yl/agent-memory/MemRL/scripts/aistudio_alfworld_qwen36_regionfs_72b_aligned.sh ${TS}"
export GPU_NUM="2"
