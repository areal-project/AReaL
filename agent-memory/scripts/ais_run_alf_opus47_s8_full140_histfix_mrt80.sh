...
cfg['experiment']['experiment_name']=f'alfworld_region_opus47_s8_full140_histfix_mrt80_{tag}'
...
PY
export MEMRL_RUN_ID="s8-full140-histfix-mrt80-${RUN_TAG}"
echo '[ID-ONLY] S8 full 140, lambda=0.03 k=15 max_steps=40 max_recent_turns=80, history fix'
