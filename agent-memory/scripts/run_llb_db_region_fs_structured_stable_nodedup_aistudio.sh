...
LOGFILE="$PROJECT_DIR/logs/llb_db_region_fs_structured_stable_nodedup_gpt41mini_${HOST_SHORT}_${TS}.log"
exec > >(tee -a "$LOGFILE") 2>&1
cd "$PROJECT_DIR"
echo '=========================================='
echo 'LLB DB Region+FS structured stable no-dedup 10-epoch training (gpt-4.1-mini)'
...
export MEMRL_RUN_ID=region-fs-db-gpt41mini-structured-stable-nodedup-20260803
...
cfg['memory']['user_id']='llb_db_region_fs_structured_stable_nodedup_user'
cfg['experiment']['experiment_name']='llb_db_region_fs_gpt41mini_structured_stable_nodedup'
...
printf '%s\n' '[INFO] Fresh structured FS: no dedup, sim/Q=0.5/0.5, topology cooldown=1.'
