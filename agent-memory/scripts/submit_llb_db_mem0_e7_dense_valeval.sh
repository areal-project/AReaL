...
export JOB_NAME="yl-llbdb-mem0-e7-dense-valeval-$(date +%m%d-%H%M)"
export JOB_COMMAND='bash /storage/openpsi/users/yl/agent-memory/MemRL/scripts/run_llb_db_mem0_e7_dense_valeval_aistudio.sh'
