...
export MEMRL_ALFWORLD_DEFERRED_REPAIR_MAX_GAMES=12
...
cfg['experiment']['experiment_name']=f'alfworld_region_opus47_s8_id_max40_{tag}'
cfg['experiment']['mode']='test';cfg['experiment']['n_eval_runs']=1;cfg['experiment']['max_steps']=40
...
PY
export MEMRL_RUN_ID="s8-id-max40-${RUN_TAG}"
echo '[ID-ONLY] S8 lambda=0.03 k=15 max_steps=40 repair_rounds=3 cooldowns=30,60,120'
