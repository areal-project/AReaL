#!/bin/bash
# Submit Qwen2.5-72B ALFWorld Region+FS clean v3 resume from S10-b10 to AIS.
set -euo pipefail
...
export WORKER_NUM="0"
export JOB_TAG="qwen72b-regionfs-clean-v3-resume-s10b10"
TS=$(date +%Y%m%d_%H%M%S)
export JOB_NAME="yl-alf-q72b-regionfs-v3-resume-s10b10-${TS}"
export KM_IMAGE="acr-sh-ant-registry-vpc.cn-shanghai.cr.aliyuncs.com/gpu/areal-runtime:dev-sglang-20260401"
export JOB_COMMAND="EMBED_PORT=19070 LLM_PORT=19270 NCCL_PORT=29670 bash /storage/openpsi/users/yl/agent-memory/MemRL/scripts/aistudio_alfworld_qwen72b_regionfs_clean_v3_resume_s10b10.sh ${TS}"
export GPU_NUM=3
