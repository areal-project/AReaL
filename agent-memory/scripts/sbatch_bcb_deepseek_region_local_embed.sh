#!/bin/bash
#SBATCH --job-name=yl-bcb-ds-region-le
...
#SBATCH --output=logs/bcb_ds_region_le_%j.log
#SBATCH --error=logs/bcb_ds_region_le_%j.log
...
echo "=========================================="
echo "BCB DeepSeek-R1-32B + Qwen3-Embedding-8B (Region)"
...
echo ''
echo '=========================================='
echo '[REGION] Starting BCB Region Memory Transfer with local embedding (10 epochs)'
echo '=========================================='

python run/run_bcb_region.py \
    --config configs/rl_bcb_config.deepseek_local_embed_region.yaml \
    --split instruct \
    --subset full \
    --epochs 10 \
    ...
    --k_global 30 \
    --k_local 10 \
    --output_dir ./results/deepseek_region_local_embed
