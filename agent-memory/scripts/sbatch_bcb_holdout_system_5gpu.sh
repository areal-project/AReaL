#!/bin/bash
#SBATCH --job-name=yl-bcb-holdout-system
...
#SBATCH --mem=400G
#SBATCH --gres=gpu:5
#SBATCH --output=logs/bcb_ds_holdout_system_5gpu_%j.log
#SBATCH --error=logs/bcb_ds_holdout_system_5gpu_%j.log
...
echo "=========================================="
echo "BCB Holdout=System (5 GPU layout)"
...
TEMP_CONFIG=/tmp/holdout_system_config_\$\$.yaml
...
echo ''
echo '=========================================='
echo '[HOLDOUT-SYSTEM] Region + Zero-Shot Transfer to System'
echo 'Config: tau=0.18, trajectory, avefact, additive gating'
echo 'Holdout: bcb/System (excluded from train)'
echo '=========================================='
...
python run/run_bcb_region.py \
    ...
    --output_dir ./results/deepseek_holdout_system_5gpu

HOLDOUT_EXIT=\$?
echo \"[INFO] Holdout-System exited with code: \$HOLDOUT_EXIT\"
