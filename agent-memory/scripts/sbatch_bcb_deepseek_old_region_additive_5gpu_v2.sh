#!/bin/bash
#SBATCH --job-name=yl-bcb-old-add-5gpu-v2
...
#SBATCH --output=logs/bcb_ds_old_region_additive_5gpu_v2_%j.log
#SBATCH --error=logs/bcb_ds_old_region_additive_5gpu_v2_%j.log
...
echo 'Region: Additive, beta, temp=0.3, top-1, min_cs=80, C=0.5'
echo '=========================================='
...
python run/run_bcb_region.py \
    ...
    --output_dir ./results/deepseek_old_region_additive_5gpu_v2
