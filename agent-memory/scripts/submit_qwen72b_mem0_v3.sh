#!/bin/bash
# Submit Qwen2.5-72B ALFWorld Mem0 v3 baseline to AIStudio.
set -euo pipefail
...
export WORKER_NUM=0
export JOB_TAG="qwen72b-mem0-v3"
TS=$(date +%Y%m%d_%H%M%S)
export JOB_NAME="yl-alf-q72b-mem0-v3-${TS}"
...
export JOB_COMMAND="MEMRL_RUN_ID=qwen72b_mem0_v3 MEM0_COLLECTION=memrl_mem0_alf_qwen72b_v3 EMBED_PORT=19090 LLM_PORT=19290 NCCL_PORT=29690 bash /storage/openpsi/users/yl/agent-memory/MemRL/scripts/aistudio_alfworld_qwen72b_mem0_vllm.sh ${TS}"
export GPU_NUM=3
