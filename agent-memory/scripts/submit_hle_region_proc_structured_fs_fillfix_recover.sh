...
JOB_RID="yl-hle-region-proc-structuredfs-fillfix-recover-$(date +%Y%m%d-%H%M%S)"
LINEAGE_RID="yl-hle-region-proc-structuredfs-fillfix-20260803-223554"
...
echo "[submit] recover HLE structured FS fillfix lineage=$LINEAGE_RID job=$JOB_RID"
