#!/bin/bash
# Submit LLB OS MemRL (claude-haiku-4-5, sandboxed) to AIStudio.
...
export JOB_TAG=""
TS=$(date +%m%d-%H%M)
export JOB_NAME="yl-llbos-memrl-gpt41mini-${TS}"
...
export JOB_COMMAND="export MEMRL_RUN_ID='${LLB_OS_RUN_ID}'; bash /storage/openpsi/users/yl/agent-memory/MemRL/scripts/run_llb_os_memrl_gpt41mini_aistudio.sh"
