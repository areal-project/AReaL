...
# Mem0: only needs 3 GPUs (1 embed + 1 LLM act + 1 LLM extract)
gpu_num = int(os.environ.get("GPU_NUM", "3"))
master = ExecConf(cpu=48, memory=600000, disk_m=800000, gpu_num=gpu_num, num=1, gpu_type="h200")
worker = ExecConf(cpu=48, memory=600000, disk_m=800000, gpu_num=gpu_num, num=worker_num, gpu_type="h200")
km_conf = KMConf(
