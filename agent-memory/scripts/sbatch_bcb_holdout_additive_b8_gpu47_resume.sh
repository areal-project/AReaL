...
echo ''
echo '=========================================='
echo '[HOLDOUT-ADDITIVE-B8] Cross-Subtask Transfer Experiment'
echo 'Config: old (tau=0.18, trajectory, avefact), bs=8'
echo 'Region: Additive gating (P0-P2: Beta posterior, temp=0.3, top-1, min_cs=15)'
...
python run/run_bcb_holdout.py \
    ...
    --resume_from ./results/deepseek_old_holdout_additive_b8/bigcodebench_eval/instruct_full/holdout/20260519_142453_deepseek-ai_DeepSeek-R1-Distill-Qwen-32B_holdout/epoch1/snapshot/step_352 \
    --resume_epoch 1 \
    --resume_step 352 \
    --output_dir ./results/deepseek_old_holdout_additive_b8

HOLDOUT_EXIT=\$?
echo \"[INFO] Holdout-Additive-B8 exited with code: \$HOLDOUT_EXIT\"
