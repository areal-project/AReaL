...
LOGFILE="/storage/openpsi/users/yl/agent-memory/MemRL/logs/aistudio_qwen72b_memp_rag_vllm_${1:-$(date +%Y%m%d_%H%M%S)}.log"
...
CFGEOF
    ...
    python3 run/run_alfworld.py --config /tmp/alf_rag_vllm_$$.yaml --skip_initial_eval
