#!/bin/bash
#SBATCH --job-name=yl-bcb-ds-tuned-rgn-ucb
...
#SBATCH --output=logs/bcb_ds_tuned_region_ucb_%j.log
#SBATCH --error=logs/bcb_ds_tuned_region_ucb_%j.log
...
echo ''
echo '=========================================='
echo '[REGION+TUNED+UCB] Starting BCB Region with UCB retrieval strategy'
echo 'Config: tau=0.30, proceduralization, query, region_retrieve_mode=ucb'
echo '=========================================='
...
python run/run_bcb_region.py \
    ...
    --k_global 30 \
    --k_local 10 \
    --region_retrieve_mode ucb \
    --output_dir ./results/deepseek_tuned_region_ucb \
