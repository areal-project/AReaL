#!/bin/bash
# Submit LLB OS Self-RAG GPT-4.1-mini to AIStudio.
set -e
...
export WORKER_NUM="0"
export JOB_TAG=""
export LLB_OS_TASK_KEY="llb-os/selfrag/gpt41mini"
TS=$(date +%m%d-%H%M)
export JOB_NAME="yl-llbos-selfrag-gpt41mini-${TS}"
...
export JOB_COMMAND="export MEMRL_RUN_ID='${LLB_OS_RUN_ID}'; bash /storage/openpsi/users/yl/agent-memory/MemRL/scripts/run_llb_os_selfrag_gpt41mini_aistudio.sh"
