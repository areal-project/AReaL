...
#SBATCH --output=logs/hle_mem0_%j.log
#SBATCH --error=logs/hle_mem0_%j.log

# HLE Mem0 baseline: mem0 library fact extraction + retrieval
# 10 sections, uses Mem0MemoryService (LLM-based atomic fact extraction)
...
echo "=========================================="
echo "HLE Mem0 Baseline: deepseek-v3.2 via SGLang"
...
python run/run_hle.py \
    --config configs/rl_hle_config.mem0_local.yaml \
