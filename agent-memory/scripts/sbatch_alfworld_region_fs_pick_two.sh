#!/bin/bash
#SBATCH --job-name=yl-alf-rfs-pick2
...
#SBATCH --output=logs/alf_rfs_pick_two_%j.log
#SBATCH --error=logs/alf_rfs_pick_two_%j.log
...
echo "=========================================="
echo "pick_two_obj_and_place — Region failure summary (resume, eval S3+S4)"
echo "Start: $(date)"
echo "=========================================="
