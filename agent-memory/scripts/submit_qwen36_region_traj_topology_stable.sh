#!/bin/bash
# Submit clean Qwen3.6 Region+FS topology-stability main experiment.
set -euo pipefail
...
export WORKER_NUM="0"
export JOB_TAG="qwen36-regionfs-topology-stable"
export JOB_NAME="yl-alf-qwen36-regionfs-topology-stable-${TS}"
export KM_IMAGE="acr-sh-ant-registry-vpc.cn-shanghai.cr.aliyuncs.com/gpu/areal-runtime:dev-vllm-20260429"
export JOB_COMMAND="bash /storage/openpsi/users/yl/agent-memory/MemRL/scripts/aistudio_alfworld_qwen36_region_traj_topology_stable.sh ${TS}"
export GPU_NUM="2"
