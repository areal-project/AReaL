#!/bin/bash
#SBATCH --job-name=yl-bcb-dsv3-leaf
...
# Region+FS with leaf clustering + dominant-region split rule.
# Key changes vs baseline (mcs=15, eom):
#   - cluster_selection_method=leaf (finer-grained cluster extraction)
#   - min_cluster_size=12
#   - max_region_share=0.30 (force split regions >30% of total)
...
echo "=========================================="
echo "BCB DeepSeek-V3 Region+FS (leaf + max_region_share=0.30)"
...
echo ''
echo '=========================================='
echo '[Region+FS leaf] DeepSeek-V3, 10 epochs'
echo '=========================================='
