...
export JOB_TAG=qwen72b-holdout-picktwo-rag
export JOB_NAME="yl-alf-q72b-picktwo-rag-${TS}"
export KM_IMAGE="acr-sh-ant-registry-vpc.cn-shanghai.cr.aliyuncs.com/gpu/areal-runtime:dev-sglang-20260401"
export JOB_COMMAND="bash /storage/openpsi/users/yl/agent-memory/MemRL/scripts/aistudio_alfworld_qwen72b_holdout_picktwo_single_baseline.sh rag ${TS}"
