#!/bin/bash
# Leaf-v9 fixed-initial topology cooldown: retain raw direct outcomes before the first Region cluster, then
...
export JOB_NAME="yl-bcb-leafv9-fixedinitcooldown-$STAMP"
export BCB_CONFIG=configs/rl_bcb_config.deepseek_v3_local_region.yaml
export BCB_EPOCHS=10
export BCB_OUTPUT_DIR=/storage/openpsi/experiments/checkpoints/admin/yl-mem-region/bigcodebench/deepseek_v3_local_region_fs_leaf_v9_fixedinit_cooldown1
