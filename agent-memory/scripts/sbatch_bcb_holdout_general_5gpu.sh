#!/bin/bash
#SBATCH --job-name=yl-bcb-holdout-general
...
#SBATCH --mem=400G
#SBATCH --gres=gpu:5
#SBATCH --output=logs/bcb_ds_holdout_general_5gpu_%j.log
#SBATCH --error=logs/bcb_ds_holdout_general_5gpu_%j.log
...
echo "=========================================="
echo "BCB Holdout=General (5 GPU layout)"
...
TEMP_CONFIG=/tmp/holdout_general_config_\$\$.yaml
...
echo ''
echo '=========================================='
echo '[HOLDOUT-GENERAL] Region + Zero-Shot Transfer to General'
echo 'Config: tau=0.18, trajectory, avefact, additive gating'
echo 'Holdout: bcb/General (excluded from train)'
echo '=========================================='
...
python run/run_bcb_region.py \
    ...
    --output_dir ./results/deepseek_holdout_general_5gpu

HOLDOUT_EXIT=\$?
echo \"[INFO] Holdout-General exited with code: \$HOLDOUT_EXIT\"
