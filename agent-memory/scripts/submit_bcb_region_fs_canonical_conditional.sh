...
export JOB_NAME="yl-bcb-regionfs-canonical-conditional-$STAMP"
export BCB_CONFIG=configs/rl_bcb_config.deepseek_v3_local_region.yaml
export BCB_EPOCHS=10
export BCB_OUTPUT_DIR=/storage/openpsi/experiments/checkpoints/admin/yl-mem-region/bigcodebench/deepseek_v3_region_fs_canonical_conditional
...
LOG_BASE="$MEMRL/logs/aistudio_bcb_regionfs_canonical_conditional_$STAMP"
