#!/bin/bash
#SBATCH --job-name=yl-bcb-ds-tuned
...
#SBATCH --output=logs/bcb_ds_tuned_%j.log
#SBATCH --error=logs/bcb_ds_tuned_%j.log
...
echo "=========================================="
echo "BCB DeepSeek-R1-32B + Qwen3-Embedding-8B (Tuned params)"
...
# --- Run MemRL experiment with tuned parameters ---
echo ''
echo '=========================================='
echo '[MEMRL-TUNED] Starting BCB MemRL with tuned parameters (10 epochs)'
echo 'Changes: tau=0.30, proceduralization, query, sim_norm=0.31/0.10'
echo '=========================================='
...
MEMRL_EXIT=\$?
echo \"[INFO] MemRL-Tuned exited with code: \$MEMRL_EXIT\"
