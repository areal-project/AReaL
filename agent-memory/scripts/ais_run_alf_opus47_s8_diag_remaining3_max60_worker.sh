...
export MEMRL_ALFWORLD_ID_GAME_FILTER="pick_cool_then_place_in_recep-Tomato-None-CounterTop-12,pick_clean_then_place_in_recep-ButterKnife-None-Drawer-30,pick_cool_then_place_in_recep-Cup-None-Microwave-17"
...
cfg['experiment']['experiment_name']=f'alfworld_region_opus47_s8_diag_remaining3_max60_{tag}'
...
PY
export MEMRL_RUN_ID="s8-diag-rem3-max60-${RUN_TAG}"
echo '[ID-DIAG] S8 remaining 3 games, lambda=0.03 k=15 max_steps=60 max_recent_turns=120'
