...
export JOB_NAME="yl-llbdb-regionfs-highconf-corrected-$(date +%m%d-%H%M)"
export KM_IMAGE='acr-sh-ant-registry-vpc.cn-shanghai.cr.aliyuncs.com/gpu/areal-runtime:dev-sglang-20260401'
export JOB_COMMAND='bash /storage/openpsi/users/yl/agent-memory/MemRL/scripts/run_llb_db_region_fs_highconf_corrected_aistudio.sh'
...
printf '%s\n' "[INFO] Submitting high-confidence corrected-topology Structured Region-FS: $JOB_NAME"
cd /tmp
