#!/bin/bash
# Submit isolated Qwen2.5-72B ALFWorld Mem0 continuation from S9 batch 10.
set -euo pipefail
...
export WORKER_NUM=0
export JOB_TAG="qwen72b-mem0-v3-s9b10-resume"
TS=$(date +%Y%m%d_%H%M%S)
export JOB_NAME="yl-alf-q72b-mem0-v3-s9b10-resume-${TS}"
...
export JOB_COMMAND="MEMRL_RUN_ID=qwen72b_mem0_v3_s9b10_resume_${TS} MEM0_COLLECTION=memrl_mem0_alf_qwen72b_v3 MEM0_RESUME_SOURCE=/storage/openpsi/experiments/checkpoints/admin/yl-mem-region/alfworld/alfworld/exp_alfworld_mem0_qwen72b_qwen72b_mem0_v3/local_cache/snapshot/s9_b10 MEM0_EXPECTED_RESUME=section=9,batch=11 MEM0_CKPT_RESUME_ENABLED=true EMBED_PORT=19090 LLM_PORT=19290 NCCL_PORT=29690 bash /storage/openpsi/users/yl/agent-memory/MemRL/scripts/aistudio_alfworld_qwen72b_mem0_vllm.sh ${TS}"
export GPU_NUM=3
