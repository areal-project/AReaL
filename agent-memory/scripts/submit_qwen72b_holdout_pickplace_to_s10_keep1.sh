...
ORIGINAL_TAG=20260729_095007; NOW=$(date +%Y%m%d_%H%M%S)
export JOB_TAG=qwen72b-holdout-pickplace-to-s10-keep1
export JOB_NAME="yl-alf-q72b-holdout-pickplace-to-s10-keep1-${NOW}"
export KM_IMAGE="acr-sh-ant-registry-vpc.cn-shanghai.cr.aliyuncs.com/gpu/areal-runtime:dev-sglang-20260401"
export JOB_COMMAND="MEMRL_ALFWORLD_LLM_CONCURRENCY=16 MEMRL_ALFWORLD_DEFERRED_REPAIR_MAX_GAMES=16 bash /storage/openpsi/users/yl/agent-memory/MemRL/scripts/aistudio_alfworld_qwen72b_holdout_traj_memrl_selfrag_to_s10_keep1.sh ${ORIGINAL_TAG}"
