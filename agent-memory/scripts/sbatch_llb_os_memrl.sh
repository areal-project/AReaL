#!/bin/bash
# MemRL LLB OS Experiment - Submit via sbatch
# Usage: bash scripts/sbatch_llb_os_memrl.sh
...
LOG_FILE="${MEMRL_DIR}/logs/llb_os_memrl_${TIMESTAMP}.log"
