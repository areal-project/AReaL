...
# --- 作业信息 ---
export WORKER_NUM=0
export JOB_NAME="yl-alf-opus47-region-$(date +%m%d-%H%M)"
...
# --- 启动命令 ---
export JOB_COMMAND="bash /storage/openpsi/users/yl/agent-memory/MemRL/scripts/ais_run_alf_opus47_region.sh"
...
python /storage/openpsi/users/yl/agent-memory/MemRL/scripts/ais_submit_alf_opus47_region.py
