#!/bin/bash
#SBATCH --job-name=yl-bcb-old-post-5gpu
...
#SBATCH --output=logs/bcb_ds_old_region_post_5gpu_%j.log
#SBATCH --error=logs/bcb_ds_old_region_post_5gpu_%j.log
...
echo ''
echo '=========================================='
echo '[MEMRL-OLD-POST] Starting BCB MemRL Post Region (10 epochs, bs=8)'
echo 'Config: tau=0.18, trajectory, avefact'
echo 'Region: Post multiplicative, beta, temp=0.3, top-1, min_cs=15'
echo '=========================================='
...
python run/run_bcb_region.py \
    ...
    --output_dir ./results/deepseek_old_region_post_5gpu

MEMRL_EXIT=\$?
echo \"[INFO] MemRL-Old-Post exited with code: \$MEMRL_EXIT\"
