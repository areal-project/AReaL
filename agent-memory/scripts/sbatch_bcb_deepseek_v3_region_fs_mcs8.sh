#!/bin/bash
#SBATCH --job-name=yl-bcb-dsv3-rfs-m8
...
# Region+FS with min_cluster_size=8 (vs baseline 15).
# Same avefact config as baseline, only change is finer clustering.
...
echo "=========================================="
echo "BCB DeepSeek-V3 Region+FS (min_cluster_size=8)"
...
echo ''
echo '=========================================='
echo '[Region+FS mcs=8] DeepSeek-V3, 10 epochs'
echo '=========================================='
...
EXIT_CODE=$?
echo "[INFO] Region+FS mcs=8 exit code: $EXIT_CODE"
