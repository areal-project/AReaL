...
# Main job: 5 GPUs (1 embed + 4 LLM, Pass@10 completed)
gpu_num = int(os.environ.get("GPU_NUM", "5"))
master = ExecConf(cpu=96, memory=1200000, disk_m=1400000, gpu_num=gpu_num, num=1, gpu_type="h200")
worker = ExecConf(cpu=96, memory=1200000, disk_m=1400000, gpu_num=gpu_num, num=worker_num, gpu_type="h200")
km_conf = KMConf(
