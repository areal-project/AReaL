...
JOB_RID="yl-hle-mem0-bm25-clean-recover-$(date +%Y%m%d-%H%M%S)"
LINEAGE_RID="yl-hle-mem0-bm25-clean-20260801-212213"
echo "[submit] recover Mem0+BM25 lineage=$LINEAGE_RID job=$JOB_RID"
