#!/bin/bash
#SBATCH --job-name=yl-bcb-dsv3-fmm-bf
...
# fmmatch + backfill (new experiment, 10 epochs from scratch)
...
echo "=========================================="
echo "BCB DeepSeek-V3 fmmatch + BACKFILL (fresh 10 epochs)"
...
echo ''
echo '=========================================='
echo '[fmmatch + BACKFILL] DeepSeek-V3, 10 epochs from scratch'
echo '=========================================='
...
EXIT_CODE=$?
echo "[INFO] fmmatch+backfill exit code: $EXIT_CODE"
