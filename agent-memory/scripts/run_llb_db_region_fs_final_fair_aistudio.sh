...
LOGFILE="$PROJECT_DIR/logs/llb_db_region_fs_final_fair_gpt41mini_${HOST_SHORT}_${TS}.log"
exec > >(tee -a "$LOGFILE") 2>&1
cd "$PROJECT_DIR"

echo '=========================================='
echo 'LLB DB final fair Region-FS: stable topology, FS1, fixed top-5'
echo "Host: $(hostname)"
...
export MEMRL_RUN_ID="region-fs-db-gpt41mini-final-fair-20260807"
...
cfg['memory']['user_id']='llb_db_region_fs_final_fair_user'
cfg['experiment']['experiment_name']='llb_db_region_fs_gpt41mini_final_fair'
...
printf '%s\n' '[INFO] Fresh final fair run: stable topology, FS1 forced after clustering, fixed top-5.'
