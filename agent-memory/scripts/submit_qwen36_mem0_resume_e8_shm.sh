#!/bin/bash
# Submit Qwen3.6 Mem0 continuation from completed E8 with tmpfs fast_downward copies.
set -euo pipefail
...
export WORKER_NUM="0"
export JOB_TAG="qwen36-mem0-resume-e8-shm"
export JOB_NAME="yl-alf-qwen36-mem0-resume-e8-shm-${TS}"
export KM_IMAGE="acr-sh-ant-registry-vpc.cn-shanghai.cr.aliyuncs.com/gpu/areal-runtime:dev-vllm-20260429"
export JOB_COMMAND="bash /storage/openpsi/users/yl/agent-memory/MemRL/scripts/aistudio_alfworld_qwen36_mem0_resume_e8_shm.sh ${TS}"
export GPU_NUM="3"
