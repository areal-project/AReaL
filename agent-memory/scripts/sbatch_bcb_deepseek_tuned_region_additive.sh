#!/bin/bash
#SBATCH --job-name=yl-bcb-ds-tuned-rgn-add
...
#SBATCH --output=logs/bcb_ds_tuned_region_additive_%j.log
#SBATCH --error=logs/bcb_ds_tuned_region_additive_%j.log
...
echo "=========================================="
echo "BCB DeepSeek-R1-32B + Qwen3-Embedding-8B (Region Additive + Tuned Config)"
...
echo ''
echo '=========================================='
echo '[REGION-ADDITIVE] Additive region gating with James-Stein shrinkage'
echo 'Top-3 region weighting, lambda_max=0.8'
echo '=========================================='
...
python run/run_bcb_region.py \
    ...
    --output_dir ./results/deepseek_tuned_region_additive

REGION_EXIT=\$?
echo \"[INFO] Region-Additive exited with code: \$REGION_EXIT\"
