#!/bin/bash
# ============================================================================
# Submit Qwen2.5-72B ALFWorld to AIStudio (8x H200, et15-aidc)
# ============================================================================
...
export JOB_NAME="yl-alf-qwen72b-${TS}"
export KM_IMAGE="acr-sh-ant-registry-vpc.cn-shanghai.cr.aliyuncs.com/gpu/areal-runtime:dev-sglang-20260401"
# Fresh run: use current TS. If AIStudio retries, same TS → auto-resume.
export JOB_COMMAND="bash /storage/openpsi/users/yl/agent-memory/MemRL/scripts/aistudio_alfworld_qwen72b.sh ${TS}"

# Override GPU type to H200
...
python /storage/openpsi/users/yl/agent-memory/MemRL/scripts/submit_qwen72b.py
