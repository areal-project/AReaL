#!/bin/bash
#SBATCH --job-name=yl-bcb-dsv3-memrl
...
#SBATCH --output=logs/bcb_dsv3_memrl_%j.log
#SBATCH --error=logs/bcb_dsv3_memrl_%j.log
...
# ==== MemRL (3 epochs, retrieve_k=10) — no-mem baseline already done separately ====
echo ''
echo '=========================================='
echo '[MemRL] retrieve_k=10, 3 epochs (full eval deps installed above)'
echo '=========================================='
