#!/bin/bash
# Fresh pick-two quality-fixed geometry/evidence + low-frequency evolving topology E1-E10.
...
OUT=/storage/openpsi/experiments/checkpoints/admin/yl-mem-region/alfworld_holdout_qwen72b_picktwo_region_quality_stable_20260807
LOG="$MEMRL_DIR/logs/alfworld_holdout_picktwo_qwen72b_region_quality_stable_$TAG"
WORK_TMP=/storage/openpsi/users/yl/agent-memory/.tmp/q72b_picktwo_region_quality_stable_${TAG}_$$
...
experiment:
  ...
  experiment_name: alfworld_holdout_picktwo_qwen72b_region_quality_stable_${TAG}
  mode: train
  num_sections: 10
  batch_size: 128
  dataset_ratio: 1.0
