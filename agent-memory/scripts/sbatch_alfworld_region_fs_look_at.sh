#!/bin/bash
#SBATCH --job-name=yl-alf-rfs-look
...
#SBATCH --output=logs/alf_rfs_look_at_%j.log
#SBATCH --error=logs/alf_rfs_look_at_%j.log

# Region failure summary: look_at_obj_in_light ONLY (4 sections from scratch)
# With thread-local Q fix, should complete well within 24h
...
echo "=========================================="
echo "look_at_obj_in_light — Region failure summary (4 sections)"
echo "Start: $(date)"
echo "=========================================="
