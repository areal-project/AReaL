#!/bin/bash
#SBATCH --job-name=yl-bcb-region-domain-add
...
#SBATCH --mem=400G
#SBATCH --gres=gpu:5
#SBATCH --output=logs/bcb_ds_region_domain_%j.log
#SBATCH --error=logs/bcb_ds_region_domain_%j.log
...
# --- Run experiment ---
echo '=========================================='
echo '[REGION-DOMAIN] Domain subtask (7 types) + propagation + exploration'
echo '=========================================='
...
python run/run_bcb_region.py \
    ...
    --output_dir ./results/deepseek_old_region_domain_add_5gpu &
MAIN_PID=$!
