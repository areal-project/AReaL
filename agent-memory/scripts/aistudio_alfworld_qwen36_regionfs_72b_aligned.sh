#!/bin/bash
# AIStudio: Qwen3.6 ALFWorld — Region+FS trajectory memory only — 72B Cell A-aligned topology-stability Region+FS main experiment.
...
export MEMRL_RUN_ID="qwen36_regionfs_72b_aligned_topostable_v1"
...
echo "Run ID: $MEMRL_RUN_ID (fresh 72B Cell A-aligned Region+FS)"
...
echo "[EXP] Region+FS 72B-Cell-A-aligned topology-stability run starting with config $CFG"
