#!/bin/bash
#SBATCH --job-name=yl-bcb-region-expcards
...
#SBATCH --mem=400G
#SBATCH --gres=gpu:5
#SBATCH --output=logs/bcb_region_expcards_%j.log
#SBATCH --error=logs/bcb_region_expcards_%j.log
...
echo "=========================================="
echo "BCB Region + Experience Cards (10 epochs)"
echo "Job ID: $SLURM_JOB_ID"
echo "Node: $SLURMD_NODENAME"
echo "Start time: $(date)"
echo "=========================================="

INNER_SCRIPT=$(mktemp /tmp/bcb_region_expcards_XXXXXX.sh)
...
TEMP_CONFIG=/tmp/bcb_region_expcards_config_$$.yaml
...
echo '=========================================='
echo 'Running Region + Experience Cards (10 epochs, DeepSeek-R1-Distill-Qwen-32B)'
echo '=========================================='
...
python run/run_bcb_region.py \
    ...
    --experience_cards_n_slots 1 \
    --output_dir /storage/openpsi/experiments/checkpoints/admin/yl-mem-region/bigcodebench/training/deepseek_region_experience_cards_5gpu

EXIT_CODE=$?
echo "[INFO] Region + Experience Cards exit code: $EXIT_CODE"
echo '[INFO] Done.'
exit $EXIT_CODE
INNEREOF
