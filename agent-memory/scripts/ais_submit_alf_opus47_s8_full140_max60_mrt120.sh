...
# --- 作业信息 ---
export WORKER_NUM=0
export JOB_NAME="yl-alf-opus47-s8-full140-max60-mrt120-$(date +%m%d-%H%M)"
...
# --- 启动命令 ---
export JOB_COMMAND="bash /storage/openpsi/users/yl/agent-memory/MemRL/scripts/ais_run_alf_opus47_s8_full140_max60_mrt120.sh"
