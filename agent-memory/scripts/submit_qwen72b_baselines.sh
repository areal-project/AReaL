#!/bin/bash
# ============================================================================
# Submit Qwen2.5-72B ALFWorld Baselines (Self-RAG/MemP/Mem0) to AIStudio (7x H200)
# ============================================================================
...
export JOB_NAME="yl-alf-qwen72b-baselines-${TS}"
export KM_IMAGE="acr-sh-ant-registry-vpc.cn-shanghai.cr.aliyuncs.com/gpu/areal-runtime:dev-sglang-20260401"
export JOB_COMMAND="bash /storage/openpsi/users/yl/agent-memory/MemRL/scripts/aistudio_alfworld_qwen72b_baselines.sh ${TS}"

# 7 GPUs: 1 embed + 3×TP2 (Self-RAG + MemP + Mem0)
export GPU_NUM=7
