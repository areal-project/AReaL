#!/bin/bash
#SBATCH --job-name=yl-bcb-dsv3-leaf-e10
...
# Resume leaf from E9 to run only E10 (complete the experiment)
...
RESUME_FROM="/storage/openpsi/experiments/checkpoints/admin/yl-mem-region/bigcodebench/deepseek_v3_local_region_fs_leaf/bigcodebench_eval/instruct_full/region/20260703_192548_deepseek-ai_DeepSeek-V3_region/epoch9/snapshot/9"

echo "=========================================="
echo "BCB DeepSeek-V3 Region+FS leaf — E10 only (resume from E9)"
...
echo ''
echo '=========================================='
echo '[Region+FS leaf] E10 only (resume from E9)'
echo '=========================================='
...
EXIT_CODE=$?
echo "[INFO] leaf E10 exit code: $EXIT_CODE"
