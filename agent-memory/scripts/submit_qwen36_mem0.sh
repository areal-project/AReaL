#!/bin/bash
# Submit Qwen3.6 ALFWorld MEM0 (3 GPU) to AIStudio
...
export JOB_NAME="yl-alf-qwen36-mem0-${TS}"
export KM_IMAGE="acr-sh-ant-registry-vpc.cn-shanghai.cr.aliyuncs.com/gpu/areal-runtime:dev-vllm-20260429"
export JOB_COMMAND="bash /storage/openpsi/users/yl/agent-memory/MemRL/scripts/aistudio_alfworld_qwen36_mem0.sh ${TS}"
export GPU_TYPE="h200"
# Override GPU count to 3 for mem0
export GPU_NUM="3"
