...
ORIGINAL_TAG=20260731_101105
NOW=$(date +%Y%m%d_%H%M%S)
export JOB_TAG=qwen72b-holdout-picktwo-3arm-to-s10
export JOB_NAME="yl-alf-q72b-holdout-picktwo-3arm-to-s10-${NOW}"
export KM_IMAGE="acr-sh-ant-registry-vpc.cn-shanghai.cr.aliyuncs.com/gpu/areal-runtime:dev-sglang-20260401"
export JOB_COMMAND="bash /storage/openpsi/users/yl/agent-memory/MemRL/scripts/aistudio_alfworld_qwen72b_holdout_picktwo_3arm_to_s10.sh ${ORIGINAL_TAG}"
