...
#SBATCH --output=logs/bcb_rag_%j.log
#SBATCH --error=logs/bcb_rag_%j.log

# BCB RAG baseline: raw trajectory storage + pure sim retrieval (no Q, no proceduralization)
# 10 epochs, standard semantic retrieval
...
LLM_PORT=8000
EMBED_PORT=8001
CONFIG=configs/rl_bcb_config.rag_local.yaml

echo "=========================================="
echo "BCB RAG Baseline: DeepSeek-V3 via SGLang"
...
echo ''
echo '=========================================='
echo '[RAG] DeepSeek-V3, trajectory storage, sim-only retrieval, 10 epochs'
echo '=========================================='
run_in_runner "python run/run_bcb.py \
    ...
    --output_dir /storage/openpsi/experiments/checkpoints/admin/yl-mem-region/bigcodebench/deepseek_v3_rag"
EXIT_CODE=$?
