#!/bin/bash
#SBATCH --job-name=yl-bcb-gpt4o-regfm5
...
#SBATCH --mem=380G
#SBATCH --gres=gpu:0
#SBATCH --output=logs/bcb_gpt4o_regfm_mcs5_%j.log
#SBATCH --error=logs/bcb_gpt4o_regfm_mcs5_%j.log
...
# KEY CHANGE: min_cluster_size=5 (was 15) to produce more fine-grained regions.
...
echo "=========================================="
echo "BCB Region+fmmatch: gpt-4o + reproduce params, min_cluster_size=5"
echo "Job ID: $SLURM_JOB_ID | Node: $SLURMD_NODENAME | Start: $(date)"
echo "=========================================="

INNER_SCRIPT=$(mktemp /tmp/bcb_gpt4o_regfm_mcs5_XXXXXX.sh)
...
echo '=========================================='
echo '[Region+fmmatch] gpt-4o, reproduce params, 10 epochs, min_cluster_size=5'
echo '=========================================='
python run/run_bcb_region.py \
    ...
    --output_dir /storage/openpsi/experiments/checkpoints/admin/yl-mem-region/bigcodebench/gpt4o_region_fmmatch_mcs5

EXIT_CODE=$?
echo "[INFO] Region+fmmatch mcs5 exit code: $EXIT_CODE"
exit $EXIT_CODE
INNEREOF
