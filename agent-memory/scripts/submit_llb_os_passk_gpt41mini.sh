#!/bin/bash
# Submit LLB OS Pass@10 (gpt-4.1-mini validation set) to AIStudio.
set -e
...
export WORKER_NUM="0"
export JOB_TAG=""
export LLB_OS_TASK_KEY="llb-os/passk/gpt41mini"
TS=$(date +%m%d-%H%M)
export JOB_NAME="yl-llbos-passk-gpt41mini-${TS}"
export KM_IMAGE="acr-sh-ant-registry-vpc.cn-shanghai.cr.aliyuncs.com/gpu/areal-runtime:dev-sglang-20260401"
export JOB_COMMAND="bash /storage/openpsi/users/yl/agent-memory/MemRL/scripts/run_llb_os_passk_gpt41mini_aistudio.sh"
