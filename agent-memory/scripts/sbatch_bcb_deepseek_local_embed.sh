#!/bin/bash
#SBATCH --job-name=yl-bcb-ds-local-embed
...
#SBATCH --output=logs/bcb_ds_local_embed_%j.log
#SBATCH --error=logs/bcb_ds_local_embed_%j.log
...
echo "=========================================="
echo "BCB DeepSeek-R1-32B + Qwen3-Embedding-8B (Local)"
...
# --- Run MemRL experiment ---
echo ''
echo '=========================================='
echo '[MEMRL] Starting BCB MemRL with local embedding (10 epochs)'
echo '=========================================='
