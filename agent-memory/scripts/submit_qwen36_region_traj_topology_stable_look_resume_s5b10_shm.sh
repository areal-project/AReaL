#!/bin/bash
# Submit Qwen3.6 Region+FS fallback-look continuation from valid E5 s5_b10.
set -euo pipefail
...
export WORKER_NUM="0"
export JOB_TAG="qwen36-regionfs-look-s5b10-shm"
export JOB_NAME="yl-alf-qwen36-regionfs-look-s5b10-shm-${TS}"
export KM_IMAGE="acr-sh-ant-registry-vpc.cn-shanghai.cr.aliyuncs.com/gpu/areal-runtime:dev-vllm-20260429"
export JOB_COMMAND="bash /storage/openpsi/users/yl/agent-memory/MemRL/scripts/aistudio_alfworld_qwen36_region_traj_topology_stable_look_resume_s5b10_shm.sh ${TS}"
export GPU_NUM="2"
