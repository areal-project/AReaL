#!/bin/bash
#SBATCH --job-name=yl-bcb-qwen25-region
...
#SBATCH --mem=400G
#SBATCH --gres=gpu:5
#SBATCH --output=logs/bcb_qwen25_region_%j.log
#SBATCH --error=logs/bcb_qwen25_region_%j.log
...
echo "=========================================="
echo "BCB Qwen2.5-32B-Instruct: Region method (10 epochs)"
echo "Job ID: $SLURM_JOB_ID"
echo "Node: $SLURMD_NODENAME"
echo "Start time: $(date)"
echo "=========================================="

INNER_SCRIPT=$(mktemp /tmp/bcb_qwen25_region_XXXXXX.sh)
...
TEMP_CONFIG=/tmp/bcb_qwen25_region_config_$$.yaml
...
# Override Qwen2.5-32B-Instruct's generation_config.json (temperature=0.7 default).
...
echo '=========================================='
echo 'Running Region (10 epochs, additive shrinkage, confgate params)'
echo '=========================================='
...
python run/run_bcb_region.py \
    ...
    --output_dir /storage/openpsi/experiments/checkpoints/admin/yl-mem-region/bigcodebench/qwen25_32b_region

EXIT_CODE=$?
echo "[INFO] Region exit code: $EXIT_CODE"
echo '[INFO] Done.'
exit $EXIT_CODE
INNEREOF
