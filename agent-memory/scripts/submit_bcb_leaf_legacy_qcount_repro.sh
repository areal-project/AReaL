#!/bin/bash
# Legacy Leaf reproducibility control. Intentionally restores historical Q*q_count
# child posterior reconstruction. This is an invalid-evidence ablation, not a main result.
set -euo pipefail
...
export JOB_NAME="yl-bcb-leaf-legacy-qcount-repro-$STAMP"
export BCB_CONFIG=configs/rl_bcb_config.deepseek_v3_local_region.yaml
export BCB_EPOCHS=10
export BCB_OUTPUT_DIR=/storage/openpsi/experiments/checkpoints/admin/yl-mem-region/bigcodebench/deepseek_v3_local_region_fs_leaf_legacy_qcount_repro
