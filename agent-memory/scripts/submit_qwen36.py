...
# H200 in et15-aidc: 16C/192G per GPU, 8 GPUs (only et15-aidc has /storage)
master = ExecConf(cpu=128, memory=1500000, disk_m=1600000, gpu_num=8, num=1, gpu_type="h200")
worker = ExecConf(cpu=128, memory=1500000, disk_m=1600000, gpu_num=8, num=worker_num, gpu_type="h200")
km_conf = KMConf(
