#!/bin/bash
# Submit Qwen3.6 ALFWorld MemRL-traj + Region-traj (3 GPU)
...
export JOB_NAME="yl-alf-qwen36-traj-${TS}"
export KM_IMAGE="acr-sh-ant-registry-vpc.cn-shanghai.cr.aliyuncs.com/gpu/areal-runtime:dev-vllm-20260429"
export JOB_COMMAND="bash /storage/openpsi/users/yl/agent-memory/MemRL/scripts/aistudio_alfworld_qwen36_traj.sh ${TS}"
