...
#SBATCH --output=logs/hle_selfrag_%j.log
#SBATCH --error=logs/hle_selfrag_%j.log

# HLE Self-RAG baseline: RAG + LLM critique to filter irrelevant memories
# 10 sections, retrieves top-5 by sim, LLM filters to top-3 relevant, then injects
...
echo "=========================================="
echo "HLE Self-RAG Baseline: deepseek-v3.2 via SGLang"
...
python run/run_hle.py \
    --config configs/rl_hle_config.selfrag_local.yaml \
