...
export JOB_TAG=""
TS=$(date +%m%d-%H%M)
export JOB_NAME="yl-llbos-regionfs-gpt41mini-${TS}"
...
export JOB_COMMAND="export MEMRL_RUN_ID='${LLB_OS_RUN_ID}'; bash /storage/openpsi/users/yl/agent-memory/MemRL/scripts/run_llb_os_region_fs_gpt41mini_aistudio.sh"
