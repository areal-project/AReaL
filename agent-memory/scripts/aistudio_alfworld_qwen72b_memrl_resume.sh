#!/bin/bash
# ============================================================================
# AIStudio: Qwen2.5-72B ALFWorld MemRL ONLY — resume from S7 (3x H200)
#
# GPU layout (3 GPUs):
#   GPU 0: Qwen3-Embedding-8B
#   GPU 1-2: Qwen2.5-72B TP=2 → MemRL (resume)
# ============================================================================
set -e
...
LOGFILE="/storage/openpsi/users/yl/agent-memory/MemRL/logs/aistudio_qwen72b_memrl_resume_${1:-$(date +%Y%m%d_%H%M%S)}.log"
...
echo "=========================================="
echo "AIStudio: Qwen2.5-72B MemRL resume (3 GPU)"
echo "Start: $(date)"
echo "=========================================="
...
# ============================================================================
# MemRL (auto-resume from latest snapshot)
# ============================================================================
cat > /tmp/alf_memrl_resume_$$.yaml << CFGEOF
llm:
  provider: openai
  api_key: EMPTY
...
echo "[EXP] 72B MemRL resume starting..."
python3 run/run_alfworld.py --config /tmp/alf_memrl_resume_$$.yaml --skip_initial_eval
echo "[EXP] 72B MemRL exit=$? at $(date)"

echo "=========================================="
echo "MemRL complete. End: $(date)"
echo "=========================================="
