...
export MEMRL_ALFWORLD_ID_GAME_FILTER="look_at_obj_in_light-CD-None-DeskLamp-314,pick_cool_then_place_in_recep-Cup-None-Microwave-17,pick_two_obj_and_place-SprayBottle-None-Toilet-402"
export MEMRL_ALFWORLD_SAVE_EVAL_TRAJECTORIES=1
...
cfg['experiment']['experiment_name']=f'alfworld_region_opus47_s8_diag3_{tag}'
cfg['experiment']['mode']='test';cfg['experiment']['n_eval_runs']=1;cfg['experiment']['max_steps']=40;cfg['experiment']['max_recent_turns']=80
...
PY
export MEMRL_RUN_ID="s8-diag3-${RUN_TAG}"
echo '[ID-DIAG] S8 3 games, lambda=0.03 k=15 max_steps=40 max_recent_turns=80'
