...
export MEMRL_RETRIEVAL_AUDIT_PATH=/storage/openpsi/experiments/checkpoints/admin/yl-mem-region/llb_v2reflect/exp_llb_db_region_fs_gpt41mini_trajectory_multiaxis_region-fs-db-gpt41mini-trajectory-multiaxis-20260724/retrieval_audit.jsonl
