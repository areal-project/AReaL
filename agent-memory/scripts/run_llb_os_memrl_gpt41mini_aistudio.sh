#!/bin/bash
# LLB OS MemRL on AIStudio with gpt-4.1-mini.
...
LOGFILE=${PROJECT_DIR}/logs/llb_os_memrl_gpt41mini_${HOST_SHORT}_${TS}.log
mkdir -p ${PROJECT_DIR}/logs
exec > >(tee -a $LOGFILE) 2>&1

echo "=========================================="
echo "MemRL - LLB OS MemRL (gpt-4.1-mini, sandboxed)"
...
source "$PROJECT_DIR/scripts/llb_os_auto_resume.sh" "llb_os_memrl_gpt41mini"
