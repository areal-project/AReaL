...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument(
        "--baseline_resume_results",
        type=str,
        default=None,
        help="External pass@k results.jsonl to copy into a fresh run before resume parsing.",
    )
    p.add_argument(
        "--mem0",
        action="store_true",
...
def main() -> None:
    ...
    runner = BCBRunner(
        ...
        baseline_resume_results=args.baseline_resume_results,
