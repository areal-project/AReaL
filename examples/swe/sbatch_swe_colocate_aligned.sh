...
#SBATCH --gres=gpu:0
#SBATCH -t 7-00:00:00
#SBATCH -o /storage/openpsi/users/zjw531248/logs/monolith-swe-%j.out
#SBATCH -e /storage/openpsi/users/zjw531248/logs/monolith-swe-%j.err
...
CONFIG_PATH=${CONFIG_PATH:-examples/swe/swe_colocate_aligned.yaml}
...
EXP_NAME=${EXP_NAME:-zjw-monolith-swe}
TRIAL_NAME=${TRIAL_NAME:-aligned-8n-0708}
N_NODES=${N_NODES:-8}
N_GPUS=${N_GPUS:-8}
ENABLE_FP32_LM_HEAD=${ENABLE_FP32_LM_HEAD:-false}
