...
The kernel implementations under :mod:`areal.models.lce.kernels` fuse
...
The :mod:`areal.models.lce.functional` submodule additionally provides
...
from areal.models.lce.functional import (
    linear_cross_entropy_logprobs,
    linear_cross_entropy_logprobs_entropy,
)
from areal.models.lce.linear_cross_entropy import (
    LinearCrossEntropy,
